...
{
    $sql = "SELECT pc.Id, h.Nombre AS Alumno, m.Nombre AS Menu, pc.Fecha_entrega, pc.Estado
    ...
    if ($desde && $hasta) {
        $sql .= " AND pc.Fecha_pedido BETWEEN :desde AND :hasta";
        $params['desde'] = $desde . ' 00:00:00';
        $params['hasta'] = $hasta . ' 23:59:59';
    }
